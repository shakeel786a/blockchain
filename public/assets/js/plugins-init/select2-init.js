  ...
  $(".js-data-example-ajax").select2({
    ...
    function formatRepo (repo) {
      ...
      var markup = "<div className='select2-result-repository clearfix'>" +
        "<div className='select2-result-repository__avatar'><img src='" + repo.owner.avatar_url + "' /></div>" +
        "<div className='select2-result-repository__meta'>" +
          "<div className='select2-result-repository__title'>" + repo.full_name + "</div>";
    
      if (repo.description) {
        markup += "<div className='select2-result-repository__description'>" + repo.description + "</div>";
      }
    
      markup += "<div className='select2-result-repository__statistics'>" +
        "<div className='select2-result-repository__forks'><i className='fa fa-flash'></i> " + repo.forks_count + " Forks</div>" +
        "<div className='select2-result-repository__stargazers'><i className='fa fa-star'></i> " + repo.stargazers_count + " Stars</div>" +
        "<div className='select2-result-repository__watchers'><i className='fa fa-eye'></i> " + repo.watchers_count + " Watchers</div>" +
      "</div>" +
      "</div></div>";
