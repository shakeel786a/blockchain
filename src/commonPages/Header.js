...
function Header(props) {
	const { history } = props
	const onClickLogout = () => history.push({ pathname: getFullRoute(loginRoute) })
    return (
		<>
			{/* Preloader start */}
			{/* <div id="preloader">
							...
							<div className="card chat dz-chat-history-box d-none">
								<div className="card-header chat-list-header text-center">
									...
									<div className="dropdown">
										<a href="javascript:void(0)" data-toggle="dropdown" ><svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><circle fill="#000000" cx="5" cy="12" r="2"/><circle fill="#000000" cx="12" cy="12" r="2"/><circle fill="#000000" cx="19" cy="12" r="2"/></g></svg></a>
										...
										<li className="active">
											<div className="d-flex bd-highlight">
												...
												<div className="ml-auto">
													<a href="javascript:void(0)" className="btn btn-primary btn-xs sharp mr-1"><i className="fa fa-pencil"></i></a>
								...
								<li className="nav-item dropdown header-profile">
									<a className="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
										...
										<div className="header-info">
											<span className="text-black"><strong>Peter Parkur111</strong></span>
									...
									<div className="dropdown-menu dropdown-menu-right">
										...
										<div className="dropdown-item ai-icon" style={{ cursor: 'pointer' }} onClick={onClickLogout}>
