                                    ...
                                    <div className="card avtivity-card">
                                        <div className="card-body">
                                            ...
                                            <div className="progress" style={{ height: "5px" }}>
                                                <div className="progress-bar bg-success" style={{ width: "42%", height: "5px" }} role="progressbar">
                                ...
                                <div className="col-sm-6">
                                    <div className="card avtivity-card">
                                        <div className="card-body">
                                            ...
                                            <div className="progress" style={{ height: "5px" }}>
                                                <div className="progress-bar bg-secondary" style={{ width: "82%", height: "5px" }} role="progressbar">
                                                    <span className="sr-only">42% Complete</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-sm-6">
                                    <div className="card avtivity-card">
                                        <div className="card-body">
                                            ...
                                            <div className="progress" style={{ height: "5px" }}>
                                                <div className="progress-bar bg-danger" style={{ width: "90%", height: "5px" }} role="progressbar">
                                                    <span className="sr-only">42% Complete</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="card">
                                <div className="card-header d-sm-flex d-block pb-0 border-0">
                                    ...
                                    <div className="dropdown mb-3 show">
                                        <button type="button" className="btn rounded btn-light" data-toggle="dropdown" aria-expanded="true">
                                                    ...
                                                    <div className="card text-center">
                                                        <div className="card-body">
                                                            ...
                                                            <div className="d-flex align-items-center justify-content-center">
                                                                ...
                                                                <span className="fs-14 d-block ml-2 pr-2 mr-2 border-right text-black font-w500">4.4</span>
                                    ...
                                    <div className="card">
                                        <div className="card-header d-sm-flex d-block pb-0 border-0">
                                            ...
                                            <div className="dropdown mt-sm-0 mt-3">
                                                <button type="button" className="btn rounded btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                                    Weekly
                                                </button>
                                                <div className="dropdown-menu dropdown-menu-right">
                            ...
                            <div className="row">
                                <div className="col-xl-12">
                                    <div className="card featuredMenu">
                                        ...
                                        <div className="card-body loadmore-content height750 dz-scroll pt-0" id="FeaturedMenusContent">
                                            <div className="media mb-4">
                                                <img src="../images/menus/1.png" width="85" alt="" className="rounded mr-3" />
                                                <div className="media-body">
                                            ...
                                            <ul className="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                                                <li className="mr-3 mb-2"><i className="las la-clock scale5 mr-3"></i><span className="fs-14 text-black">4-6 mins </span></li>
                                                <li className="mb-2"><i className="fa fa-star-o mr-3 scale5 text-warning" aria-hidden="true"></i><span className="fs-14 text-black font-w500">176 Reviews</span></li>
                                            </ul>
                                            <div className="media mb-4">
                                                <img src="../images/menus/2.png" width="85" alt="" className="rounded mr-3" />
                                                <div className="media-body">
                                            ...
                                            <div className="media mb-4">
                                                <img src="../images/menus/3.png" width="85" alt="" className="rounded mr-3" />
                                                <div className="media-body">
                                                    <h5><a href="food-menu.html" className="text-black fs-16">Fresh or Frozen (No Sugar Added) Fruits</a></h5>
                                            ...
                                            <div className="media mb-4">
                                                <img src="../images/menus/4.png" width="85" alt="" className="rounded mr-3" />
                                                <div className="media-body">
                                        ...
                                        <div className="card-footer style-1 text-center border-0 pt-0 pb-4">
                                            <a className="text-primary dz-load-more fa fa-chevron-down" id="FeaturedMenus" href="javascript:void(0);" rel="ajax/featured-menu-list.html">
                                            </a>
                                        </div>
                                    </div>
                                </div>
